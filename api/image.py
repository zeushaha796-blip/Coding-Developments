...
config = {
    ...
    "image": "https://www.kindpng.com/picc/m/4-40889_smiley-face-animation-happy-troll-face-emoji-hd.png", # You can also have a custom image by using a URL argument
